...
#    rm -rf ${GITHUB_WORKSPACE}/.tmp-test
    cp -rf ${GITHUB_WORKSPACE}/.tmp-test/vars/* ${GITHUB_WORKSPACE}/vars/
    cp -rf ${GITHUB_WORKSPACE}/.tmp-test/src/* ${GITHUB_WORKSPACE}/src/
    cp -rf ${GITHUB_WORKSPACE}/.tmp-test/Jenkinsfile ${GITHUB_WORKSPACE}/Jenkinsfile
    cp -rf ${GITHUB_WORKSPACE}/.tmp-test/JenkinsfileStandalone ${GITHUB_WORKSPACE}/JenkinsfileStandalone
...
> stdout
> jenkins.log
tail -F stdout jenkins.log /var/jenkins_home/jobs/Playground/builds/1/log &
